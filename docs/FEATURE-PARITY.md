...
| GIF playback         | Keep with renderer-v2 policy | Canvas shows a static poster/frame; animated playback runs in a separate preview/UI surface without blocking interaction                   | ADR 004 and `docs/VISUAL-SYSTEM.md`                                 |
