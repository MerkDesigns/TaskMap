...
| `scripts/material-architecture-rules.mjs`                              |   147 | Repository maintenance script                                                               |
| `scripts/material-architecture-rules.test.mjs`                         |   182 | Tests for the adjacent module                                                               |
...
| `src/main.tsx`                                                         |    41 | TypeScript application module                                                               |
...
| `src/ui/materials/liquid-dom/index.ts`                                 |     4 | TypeScript application module                                                               |
...
| `src/ui/materials/liquid-dom/liquidDomRuntime.test.ts`                 |   115 | Tests for the adjacent module                                                               |
| `src/ui/materials/liquid-dom/liquidDomRuntime.ts`                      |    89 | The Html host owns interaction when a surface contains normal DOM controls.                 |
| `src/ui/materials/liquid-dom/LiquidMaterialSurface.tsx`                |    73 | React component or typed UI module                                                          |
