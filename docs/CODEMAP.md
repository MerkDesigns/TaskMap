...
| `src/domain/document/documentSchema.test.ts`                   |   108 | @vitest-environment node                                                        |
| `src/domain/document/documentSchema.ts`                        |   223 | TypeScript application module                                                   |
| `src/domain/document/documentTestFixtures.ts`                  |   121 | TypeScript application module                                                   |
...
| `src/domain/document/jsonSafety.ts`                            |    92 | TypeScript application module                                                   |
