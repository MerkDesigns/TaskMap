...
| `src/ui/renderer-v2-prototype/BenchmarkCanvasBrowser.test.tsx`         |    56 | Tests for the adjacent module                                                               |
| `src/ui/renderer-v2-prototype/BenchmarkCanvasBrowser.tsx`              |   138 | React component or typed UI module                                                          |
| `src/ui/renderer-v2-prototype/benchmarkCanvasBrowserLayout.ts`         |    66 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/benchmarkCanvasCardInteraction.test.ts`  |    29 | @vitest-environment node                                                                    |
| `src/ui/renderer-v2-prototype/benchmarkCanvasCardInteraction.ts`       |    77 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/BenchmarkControls.test.tsx`              |    39 | Tests for the adjacent module                                                               |
| `src/ui/renderer-v2-prototype/BenchmarkControls.tsx`                   |   141 | React component or typed UI module                                                          |
...
| `src/ui/renderer-v2-prototype/BenchmarkLiquidStage.tsx`                |    85 | React component or typed UI module                                                          |
| `src/ui/renderer-v2-prototype/benchmarkMetrics.test.ts`                |    50 | @vitest-environment node                                                                    |
| `src/ui/renderer-v2-prototype/benchmarkMetrics.ts`                     |   148 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/BenchmarkMetricsOverlay.tsx`             |    99 | React component or typed UI module                                                          |
| `src/ui/renderer-v2-prototype/benchmarkPresentation.ts`                |    21 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/BenchmarkSceneElement.tsx`               |   217 | React component or typed UI module                                                          |
...
| `src/ui/renderer-v2-prototype/liquidCanvasBrowserTypes.ts`             |    24 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/liquidCanvasCardGeometry.ts`             |    80 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/liquidCaptureProbe.test.ts`              |    34 | @vitest-environment node                                                                    |
| `src/ui/renderer-v2-prototype/liquidCaptureProbe.ts`                   |    63 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/liquidSceneBenchmarkRuntime.test.ts`     |   210 | Tests for the adjacent module                                                               |
| `src/ui/renderer-v2-prototype/liquidSceneBenchmarkRuntime.ts`          |   105 | TypeScript application module                                                               |
| `src/ui/renderer-v2-prototype/RendererV2Prototype.tsx`                 |   140 | React component or typed UI module                                                          |
