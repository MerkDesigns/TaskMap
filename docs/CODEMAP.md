...
| `src/features/phase2-database/phase2Document.ts`               |    61 | TypeScript application module                                                 |
| `src/features/phase2-database/Phase2HarnessHeader.tsx`         |    20 | React component or typed UI module                                            |
| `src/features/phase2-database/phase2HarnessState.test.ts`      |    55 | Tests for the adjacent module                                                 |
...
| `src/features/phase2-database/phase2LockOperation.test.ts`     |    60 | Tests for the adjacent module                                                 |
...
| `src/platform/database/databaseDocumentCodec.ts`               |    42 | TypeScript application module                                                 |
| `src/platform/database/databaseTypes.ts`                       |    55 | TypeScript application module                                                 |
| `src/platform/database/tauriDatabaseClient.test.ts`            |   156 | Tests for the adjacent module                                                 |
